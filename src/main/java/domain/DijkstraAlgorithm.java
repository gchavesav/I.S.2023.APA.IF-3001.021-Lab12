...
//el camino más corto para un unico origen
//Se emplea una matrix de adjacencia para representar el grafo

public class DijkstraAlgorithm {


    static final int V = 9;   // Numero de vertices en el grafo
    ...
    // Función utilitaria para imprimir el arreglo de distancias calculadas
